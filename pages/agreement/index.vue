<template>
	<div class="flexColAllWidthCls">
		<div class="flexRowAllWidthCls" style="width: 100%;background-color: #fff;" v-if="pageTitle=='用户服务协议'">
			<!-- 用户服务协议 -->
			<div style="width: 95%;margin-top: 10px;" v-html="content1">
				
			</div>
		</div>
		<div v-else class="flexRowAllWidthCls" style="width: 100%;background-color: #fff;">
			<!-- 隐私政策 -->
			<div style="width: 95%;margin-top: 10px;" v-html="content2">
				
			</div>
		</div>
		<button type="warn" style="margin:20px 0;width: 50%;" @click="goBackClick">返回</button>
	</div>
</template>
...
<script>
	export default{
		...
		data() {
			return {
				pageTitle: "",
				content1: "&nbsp;&nbsp;为使用本软件及服务，您应当阅读并遵守《本软件许可协议》（以下简称（本协议）。请您务必审慎阅读，充分理解各条款内容，特别是免除或者限制责任的条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。限制，免责条款可能以加粗形式提示您注意。\
				...
				<br /><br />\
				二，关于本服务<br />\
				本服务内容是指本软件客户端软件提供包括但不限于微信小程序等多个版本，您必须选择与所安装手机相匹配的软件版本。\
				<br /><br />\
				三，软件的获取<br />\
				您可以直接从本软件授权的第三方获取。\
				...
				content2: "隐私政策尊重并保护所有使用隐私政策网络服务用户的个人隐私权。为了给您提供更准确、更有个性化的服务，我们的隐私政策涵盖我们收集，使用，披露，传输和存储您的信息的方式。但隐私政策将以高度的勤勉、审慎义务对待这些信息。隐私政策会不时更新本隐私权政策。 您在同意隐私政策络服务使用协议之时，即视为您已经同意本隐私权政策全部内容。本隐私权政策属于隐私政策络服务使用协议不可分割的一部分。你不是一定要提供我们要求的个人信息，但在许多情况下，如果你选择不提供，我们将无法为你提供我们的产品或服务，也无法回应你遇到的任何问题。\
						<br /><br />\
						一、我们如何收集信息<br />\
						...
						<br /><br />\
						1. 您提供账号注册、登录功能及服务，可能需要您提供如下账号注册信息：<br />\
						当您注册账号时，会向我们提供手机号码、邮箱等。\
						<br /><br />\
						...
						对我们的产品和服务的详细使用情况，此种信息可能包括您访问的页面地址、以及您在使用服务时浏览或要求提供的其他信息和内容详情，除以上所述设备信息外，我们可能收集您使用的软件的版本号、浏览器类型。为确保您操作环境的安全或提供服务所需，我们会收集有关您使用的移动应用和其他软件的信息，包括崩溃、系统活动信息及其他相关信息。\
						<br /><br />\
						6. 经您同意后收集的其他信息<br />\
						为向您提供更便捷、更优质、个性化的产品或服务，我们的部分产品和服务的个别特定功能可能需要您提供特定的个人敏感信息来实现。若您选择不提供该类信息，则可能无法正常使用对应功能，但不影响您使用服务中的其他功能。这些功能包括：<br />\
						（1）转账功能：为转账时验证身份，需要您提供身份证号及银行账号等信息。\
						<br /><br />\
						（2）基于相册（图片库/视频库）的图片/视频访问及上传的应用功能：您可在开启相册权限后使用对应功能对你的照片/图片/视频进行编辑处理。\
						<br /><br />\
						您理解并同意，上述应用功能可能需要您在您的设备中向我们开启您的相册（图片库）的访问权限，以实现这些功能所涉及的信息的收集和使用。请您注意，收集个人敏感信息前，我们会以弹窗或类似显著方式获取您的同意。若您主动提供您的个人敏感信息，即表示您同意我们按本政策所述目的和方式来处理您的个人敏感信息\
						<br /><br />\
						二、我们如何使用收集的信息<br />\
						...
						5. 邀请您参与有关我们服务的调查 。\
						<br /><br />\
						6. 根据法律法规在如下情形收集使用您的相关信息，此种情况下无须获得您的授权。<br />\
						与国家安全、国防安全有关的；<br />\
						与公共安全、公共卫生、重大公共利益有关的；<br />\
						与犯罪侦查、起诉、审判和判决执行等有关的；<br />\
						出于维护个人信息主体或其他个人的生命、财产等重大合法权益但又很难得到本人同意的；<br />\
						用于维护所提供的产品与/或服务的安全稳定运行所必需的，包括发现、处置产品与/或服务的故障等；<br />\
						为合法的新闻报道所必需的；<br />\
						...
						<br /><br />\
						三、我们如何共享、转让、公开披露你的个人信息<br />\
						我们充分知晓因违法共享、转让、公开披露个人信息对个人信息主体造成损害时所应承担的法律责任，对于你的个人信息的一切共享、转让、公开披露，我们将严格按照以下条款进行：<br />\
						(一)  共享<br />\
						...
						<br /><br />\
						3. 在以下情形中，按照法律法规要求，我们将无法响应你的请求：<br />\
						与国家安全、国防安全直接相关的。<br />\
						与公共安全、公共卫生、重大公共利益直接相关的。<br />\
						与犯罪侦查、起诉、审判和判决执行等直接相关的。<br />\
						有充分证据表明你存在主观恶意或滥用权利的。<br />\
						响应你的请求将导致你或其他个人、组织的合法权益受到严重损害的。<br />\
						涉及商业秘密的。\
						<br /><br />\
						六、关于儿童的个人信息<br />\
						我们的产品、网站和服务主要面向成人。如果没有父母或监护人的同意，未成年人不得创建自己的用户账户。对于经父母同意而收集未成年个人信息的情况，我们只会在司法机关或行政机关要求、父母或监护人明确同意或者保护未成年人所必要的情况下使用或公开披露此信息。<br />\
						尽管当地法律和习俗对未成年人的定义不同，但我们将不满 16 周岁的任何人均视为未成年人。<br />\
